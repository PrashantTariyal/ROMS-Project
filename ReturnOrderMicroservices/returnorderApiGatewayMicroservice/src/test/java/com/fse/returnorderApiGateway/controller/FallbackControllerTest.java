...
import com.fse.returnorderApiGateway.controller.FallbackController;
...
class FallbackControllerTest {
    ...
    void testComponentReturnServiceFallback() {
        ...
        assertEquals("Return Service is down currently,  Try Again Later",
    ...
    void testPackagingAndDeliveryServiceFallback() {
        ...
        assertEquals("Packaging & Delivery Service is down currently,  Try Again Later",
    ...
    void testAuthServiceFallback() {
        ...
        assertEquals("Authentication Service is down currently,  Try Again Later", (new FallbackController()).authServiceFallback());
    }
}
